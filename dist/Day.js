          ...
          var O = (function () {
              ...
              return (
                    ...
                    l = function (t, n) {
                      return w.w(
                        e
                          ...
                          [t].apply(
                            e.toDate("s"),
                            (h ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(n)
                          ),
                        e
                      );
                    },
                ...
                (v.add = function (e, h) {
                  ...
                  if ($ === o) return this.set(o, this.$M + e);
                  if ($ === f) return this.set(f, this.$y + e);
                  if ($ === u) return l(1);
                  if ($ === a) return l(7);
                  var M =
                      ((c = {}), (c[i] = t), (c[s] = n), (c[r] = 1e3), c)[$] ||
                      1,
                    v = this.$d.getTime() + e * M;
                  return w.w(v, this);
                }),
                ...
                (v.format = function (t) {
                  ...
                  var r = t || "YYYY-MM-DDTHH:mm:ssZ",
                    ...
                    h = e.months,
                    f = function (t, e, i, s) {
                      return (t && (t[e] || t(n, r))) || i[e].slice(0, s);
                    },
                    c = function (t) {
                    ...
                    M = {
                      ...
                      M: a + 1,
                      MM: w.s(a + 1, 2, "0"),
                      MMM: f(e.monthsShort, a, h, 3),
                      MMMM: f(h, a),
                      D: this.$D,
                      DD: w.s(this.$D, 2, "0"),
                      d: String(this.$W),
                      dd: f(e.weekdaysMin, this.$W, o, 2),
                      ddd: f(e.weekdaysShort, this.$W, o, 3),
                      dddd: o[this.$W],
                      H: String(s),
                      HH: w.s(s, 2, "0"),
                      h: c(1),
                  ...
                  return r.replace(l, function (t, n) {
                    return n || M[t] || i.replace(":", "");
                  });
                }),
                (v.utcOffset = function () {
                  return 15 * -Math.round(this.$d.getTimezoneOffset() / 15);
                }),
                (v.diff = function (e, c, d) {
                  var $,
                    l = w.p(c),
                    M = S(e),
